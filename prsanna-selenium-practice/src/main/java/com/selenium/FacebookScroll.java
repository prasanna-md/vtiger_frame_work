...
public class FacebookScroll {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		FacebookScroll aa=new FacebookScroll();
		aa.takescreenshot(driver, "faceboom Home Page");
		JavascriptExecutor js=(JavascriptExecutor) driver;
		js.executeScript("window.scrollBy(0,500)");
		Thread.sleep(1000);
		aa.takescreenshot(driver, "facebook Home Page scroll down");
		js.executeScript("window.scrollBy(0,-500)");
		Thread.sleep(1000);
		aa.takescreenshot(driver,"facebook Home Page scroll up");
